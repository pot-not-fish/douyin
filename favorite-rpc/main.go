/*
 * @Author: LIKE_A_STAR
 * @Date: 2024-02-29 19:02:42
 * @LastEditors: LIKE_A_STAR
 * @LastEditTime: 2024-03-21 15:03:01
 * @Description:
 * @FilePath: \vscode programd:\vscode\goWorker\src\douyin\favorite-rpc\main.go
 */
package main

import (
	"douyin/favorite-rpc/favorite_rpc/favoriteservice"
	"douyin/favorite-rpc/handler"
...
func main() {
	...
	addr, _ := net.ResolveTCPAddr("tcp", "0.0.0.0:8886")
